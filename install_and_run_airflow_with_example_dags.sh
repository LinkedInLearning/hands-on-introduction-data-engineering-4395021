...
echo "${BPurple}Note From Instructor: ${NC} This script will install Airflow ${URed}WITH${NC} the example dags. If you want Airflow ${URed}WITHOUT${NC} the example dags please run install_and_run_airflow_no_example_dags.sh"
sleep 5
...
echo "Changing value of ${BRed}load_examples${NC} in airflow.cfg.py to ${BPurple}True${NC}"
